...
const artworkData = [
  ...
  { id: 8, title: "More Kiyosumi", filename: "just-as-you-are.jpg", description: "only because kiyo herself said that there might be a reward :>" },
]
      ...
      <main className="flex-1 px-6 py-8">
        ...
        {showArtwork && (
          <section id="artwork-section" className="mb-12">
            <h2 className="font-mono text-green-400 text-lg mb-4">$ ls ~/artwork - Hope you enjoy my art, Dear visitor! - If you have any questions regarding my work, feel free to drop a dm on discord~! ^-^</h2>
